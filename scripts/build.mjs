...
if (!directPatchedEntry.includes(noPromptGate) || !directPatchedEntry.includes(directConfirmationGate) || !directPatchedEntry.includes(clientOnlyGate)) throw new Error("Expected local chat gates were not found");
...
const galleryEntry = directPatchedEntry.replace(directConfirmationGate, directConfirmationReplacement).replace(clientOnlyGate, clientOnlyGateReplacement).replace(noPromptGate, noPromptGateReplacement);
