...
if (!directPatchedEntry.includes(noPromptGate) || !directPatchedEntry.includes(directConfirmationGate) || !directPatchedEntry.includes(clientOnlyGate) || !directPatchedEntry.includes(chatModeGate) || !directPatchedEntry.includes(enhanceMethod)) throw new Error("Expected local chat/enhance gates were not found");
...
if (!galleryEntry.includes(galleryPageMethod) || !galleryEntry.includes(galleryDeleteMethod) || !galleryEntry.includes(galleryShareMethod) || !galleryEntry.includes(galleryToggleMethod) || !galleryEntry.includes(galleryAccess) || !galleryEntry.includes(galleryContext)) throw new Error("Expected local gallery integration signatures were not found");
...
let vectorEntry = galleryEntry.replace(enhanceMethod, enhanceReplacement).replace(galleryPageMethod, galleryPageReplacement).replace(galleryDeleteMethod, galleryDeleteReplacement).replace(galleryShareMethod, galleryShareReplacement).replace(galleryToggleMethod, galleryToggleReplacement).replace(galleryAccess, galleryAccessReplacement).replace(galleryContext, galleryContext.replace("!!e.userInfo.alive", "!!(e.userInfo.alive||typeof globalThis.__boobastudioLocalProviderConfigured===\"function\"&&globalThis.__boobastudioLocalProviderConfigured())"));
