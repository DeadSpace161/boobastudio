...
if (!imageOperationPatchedEntry.includes(hostedSongCopy) || !imageOperationPatchedEntry.includes(hostedSongPlayback)) throw new Error("Expected gallery song URL handlers were not found");
const songPatchedEntry = imageOperationPatchedEntry.replace(hostedSongCopy, localSongCopy).replace(hostedSongPlayback, localSongPlayback);
