...
This status reflects the locally built package prepared as version **2.2.95**. The public test server is now running 2.2.95 after an automated Foundry setup installation from the public GitHub manifest.
