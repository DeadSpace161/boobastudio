...
The highest-value remaining work is clearer capability/error presentation for user-supplied image models and deeper workflow-specific validation for advanced image tools. Public community gallery actions and AI document translation remain intentionally out of the local-only slice.
