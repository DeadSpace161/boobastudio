...
2. Paste the current manifest URL:
   ...
   `https://raw.githubusercontent.com/DeadSpace161/boobastudio/main/releases/boobastudio-2.2.116-manifest.json`

3. Install **BoobaStudio**, enable it in the world, and restart or reload the world.

The release archive is also available at:

`https://raw.githubusercontent.com/DeadSpace161/boobastudio/main/releases/boobastudio-2.2.116.zip`
