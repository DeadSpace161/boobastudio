...
The current locally packaged release is **2.2.86**. The live Foundry probe described below predates the latest unpublished release because repository write access is still unavailable.
