...
The current locally packaged release is **2.2.97**. The public test world reports 2.2.95 until the versioned-asset JavaScript release is installed; the 2.2.97 manifest and ZIP are independently verified.
