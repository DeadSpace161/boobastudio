...
The current locally packaged release is **2.2.95**. The public test world currently reports 2.2.89 because its setup administrator authentication has not permitted an automated update; the 2.2.95 manifest and ZIP are published and independently verified.
